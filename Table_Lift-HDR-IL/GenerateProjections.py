...
parser.add_argument('-features', default=15, help='Number of features')
...
with torch.no_grad():
    ...
    while start < trainsize:
        ...
        a1 = train_set[start:start + datasize]
...
with open('projection_data/output.csv', 'w', newline='') as f:
