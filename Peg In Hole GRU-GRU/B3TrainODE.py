...
p1decoder_optimizer = optim.Adam(p1decoder.parameters(), lr=0.00004)
...
model1 = B2ODEModel.ODEVAE(input_size, output_size, n_latent, gcn1, p1decoder, p1encoder_optimizer,
