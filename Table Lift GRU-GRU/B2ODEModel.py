...
class GAT(nn.Module):
    def __init__(self, g, in_dim, hidden_dim, latent_dim, num_heads):
        ...
        self.hid6 = nn.Linear(hidden_dim, hidden_dim)
        self.hid7 = nn.Linear(hidden_dim, hidden_dim)
        self.hid8 = nn.Linear(hidden_dim, hidden_dim)
        self.hid9 = nn.Linear(hidden_dim, hidden_dim)
        self.hid10 = nn.Linear(hidden_dim, hidden_dim)
        self.hid11 = nn.Linear(hidden_dim, hidden_dim)
        self.hid12 = nn.Linear(hidden_dim, hidden_dim)
        self.hid13 = nn.Linear(hidden_dim, hidden_dim)
        self.hid14 = nn.Linear(hidden_dim, hidden_dim)
        self.hid15 = nn.Linear(hidden_dim, hidden_dim)
        self.hid16 = nn.Linear(hidden_dim, hidden_dim)
        self.hid17 = nn.Linear(hidden_dim, hidden_dim)
        self.hid18 = nn.Linear(hidden_dim, hidden_dim)
        self.hid19 = nn.Linear(hidden_dim, hidden_dim)
...
class NeuralODEDecoder(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dim):
        ...
        self.l2h6 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h7 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h8 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h9 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h10 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h11 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h12 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h13 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h14 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h15 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h16 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h17 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h18 = nn.Linear(hidden_dim, hidden_dim)
        self.l2h19 = nn.Linear(hidden_dim, hidden_dim)
...
class ODEVAE(nn.Module):
    ...
    def generate_mean_variance(self, seed_x, time, size):
        ...
        for i in range(0, 1):
            output = self.generate_with_seed(seed_x, size).cuda()
            print(output.size())
